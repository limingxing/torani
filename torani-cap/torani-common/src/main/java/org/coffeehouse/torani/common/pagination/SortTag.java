package org.coffeehouse.torani.common.pagination;
...
/**
 * SortTag is the sort header tag for web server side sorting by click header.
 ...
 *
 */
public class SortTag extends AbstractHtmlElementTag {
